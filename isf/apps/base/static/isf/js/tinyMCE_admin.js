...
tinyMCE.init({
    ...
    // Plugins
    plugins: 'fullscreen,paste,media,searchreplace,',
    
    // Theme Advanced
    theme_advanced_toolbar_location: 'top',
    theme_advanced_toolbar_align: 'left',
    theme_advanced_statusbar_location: 'bottom',
    theme_advanced_buttons1: 'formatselect,|,bold,italic,underline,|,bullist,numlist,blockquote,|,undo,redo,|,link,unlink,|,image,|,fullscreen,|,search,|,pasteword,template,media,charmap,|,code,|,table,cleanup,',
